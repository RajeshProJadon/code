...
dayLabel.grid(row=1, column=0, sticky='w')
monthLabel.grid(row=1, column=1, sticky='w')
yearLabel.grid(row=1, column=2, sticky='w')
# Date spinners
daySpin = tkinter.Spinbox(dateFrame, width=5, from_=1, to=31)
monthSpin = tkinter.Spinbox(dateFrame, width=5, values=("Jan", "Feb", "Mar", "April", "May", "June",
                                                        "July", "Aug", "Sep", "Oct", "Nov", "Dec"))
yearSpin = tkinter.Spinbox(dateFrame, width=5, from_=1900, to=9999)
