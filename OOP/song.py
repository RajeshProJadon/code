class Song:
    ...
    Attributes:
        ...
        artist (Artist): An artist represent the song's creator.
...
class Album:
    ...
    Attibutes:
        ...
        artist (Artist): the artist responsible for the album.
            If not specified, the artist will default to an artists with the name
            "Various Artists"
    ...
    def add_song(self, song, position=None):
        ...
        Args:
            ...
            position (Optional[int]): If specified, the song will be added to that position
                in the track list -  inserting it between other songd if necessary.
...
class Artist:
    ...
    Methods:
        add_albums: Use to add a new albums to the artist's albums list
    """
...
def find_object(field, object_list):
    """ Check 'object_list' to see if an object with a 'name' attribute equal to 'field' exists, return if it so  """
...
def load_data():
    ...
    with open("albums.txt", "r") as albums:
        for line in albums:
            # data raw should consist of (artist, album, year, song)
